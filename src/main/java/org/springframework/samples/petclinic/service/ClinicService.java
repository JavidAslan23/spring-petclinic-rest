...
public interface ClinicService {
    ...
    List<Visit> getAllVisits() throws DataAccessException;
    ...
    Visit getVisitById(int visitId) throws DataAccessException;

    // I added new method which combine in itself finding and update process
    void updateVisit(int visitId, Visit visit) throws DataAccessException;
